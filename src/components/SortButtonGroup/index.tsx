...
export const SortButtonGroup = React.memo<Props>(({sortOrder, onSortOrderChange, marketFilter, onMarketFilterChange, searchQuery, onSearchQueryChange}) => {
    return (
        <div className="mx-auto mb-6 flex max-w-320 flex-wrap items-center justify-between gap-4">
            ...
            <SearchField autoFocus value={searchQuery} onChange={onSearchQueryChange} className="gap-4 w-full md:w-[260px]">
