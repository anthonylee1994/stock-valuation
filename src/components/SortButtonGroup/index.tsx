...
import {SectorFilterSelect} from "./SectorFilterSelect";
...
interface Props {
    ...
    onSectorFilterChange: (sector: Sector | null) => void;
    searchQuery: string;
    onSearchQueryChange: (query: string) => void;
}

export const SortButtonGroup = React.memo<Props>(
    ({sortOrder, onSortOrderChange, marketFilter, onMarketFilterChange, sectors, sectorFilter, onSectorFilterChange, searchQuery, onSearchQueryChange}) => {
        return (
            <div className="mx-auto mb-4 flex max-w-[1600px] flex-wrap items-center justify-between gap-3 font-mono">
                <div className="flex w-full flex-wrap items-center justify-between gap-3 md:w-auto md:justify-start">
                    ...
                    <SectorFilterSelect sectors={sectors} value={sectorFilter} onChange={onSectorFilterChange} />
                </div>
