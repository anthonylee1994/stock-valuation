...
export const StockCard = ({stock}: Props) => {
    ...
    return (
        <Card role="article" aria-labelledby={`card-title-${symbol}`} className={`bg-surface shadow-surface transition-all duration-500 hover:shadow-overlay border-2 border-${config.color}`}>
